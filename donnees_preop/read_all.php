...
if($num>0){
    ...
    while ($row = $stmt->fetch(PDO::FETCH_ASSOC)){
        ...
        extract($row);
         ...
         $donnees_preop_item=array(
            "ID_PREOP" => $id_preop,
            "NOM_PREOP" => $nom_preop
        );
 
        array_push($donnees_preops_arr, $donnees_preop_item);
    }
    ...
    echo json_encode($donnees_preops_arr);
}
