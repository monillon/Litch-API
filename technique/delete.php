...
if (!empty($id_technique)) {

    // set manipulation property values
    $technique->id_tissu = $id_technique;

    // delete the manipulation
    if ($technique->delete($id_technique)) {

        // set response code - 201 created
        http_response_code(201);

        // tell the user
        echo json_encode(array("message" => "technique was deleted."));
        ...
        // tell the user
        echo json_encode(array("message" => "Unable to delete technique."));
    }
