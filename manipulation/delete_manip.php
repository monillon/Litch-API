...
if(!empty($id_prelevement))
{
    ...
    if($manipulation->delete_manip($id_prelevement)){
 
        // set response code - 201 created
        http_response_code(201);
 
        // tell the user
        echo json_encode(array("message" => "manipulation was deleted."));
    }
    ...
    // if unable to delete the manipulation, tell the user
        ...
        // tell the user
        echo json_encode(array("message" => "Unable to delete manipulation."));
    }
}
